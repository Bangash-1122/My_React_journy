...
###0.2.2 23 Nov 2016
* (BUG FIX): `onSave` feature.Try to fix the `Save loop` problem.[Issue [#20](https://github.com/lonefy/vscode-js-css-html-formatter/issues/20)](https://github.com/Lonefy/vscode-JS-CSS-HTML-formatter/issues/20)
* New VSCode API changes:[Issue [#30](https://github.com/lonefy/vscode-js-css-html-formatter/issues/30)](https://github.com/Lonefy/vscode-JS-CSS-HTML-formatter/issues/30);

###0.2.0 20 July 2016
* New Feature: `SCSS support`[Issue [#14](https://github.com/lonefy/vscode-js-css-html-formatter/issues/14)](https://github.com/Lonefy/vscode-JS-CSS-HTML-formatter/issues/14)

###0.1.32 15 July 2016
* (BUG FIX) Path maybe undefined
* ES6/7 Import Syntax **Need to update your `formatter.json` file** [Issue [#9](https://github.com/lonefy/vscode-js-css-html-formatter/issues/9)](https://github.com/Lonefy/vscode-JS-CSS-HTML-formatter/issues/9)
* Avoid line break to indent the CSS code[Issue [#8](https://github.com/lonefy/vscode-js-css-html-formatter/issues/8)](https://github.com/Lonefy/vscode-JS-CSS-HTML-formatter/issues/8) 

###0.1.3 06 May 2016
* New Feature: `on save`.[Issue [#4](https://github.com/lonefy/vscode-js-css-html-formatter/issues/4)](https://github.com/Lonefy/vscode-JS-CSS-HTML-formatter/issues/4)
